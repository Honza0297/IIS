            ...
            if ($logged){
                ...
                /////////////////////
                    ...
                    if ($_GET["action"]=="new"&&isset($_GET["ticketID"])){
                        ...
                        echo "<label for=\"deadline\">Deadline</label><br>";
                        echo "<label for=\"deadline\">(yyyy-mm-dd):</label><input id=\"deadline\" value=\"0000-00-00\" name=\"deadline\" type=\"text\"><br>";
                    ...
                    //////////////////
                        ...
                        if ($task!=null){                        
                            ...
                            $task->loadModels();
                            $temp = $task->ticket;
                            echo "<a class='info' href=\"ticket.php?id=$temp->id\">Ticket: $temp->title</a><br>";
                            $temp->loadModels();
                            $temp = $temp->product;
                            echo "<a class='info' href=\"product.php?id=$temp->id\">Product: $temp->name</a><br>";
                            echo "<label for=\"deadline\">Deadline</label><br>";
                            echo "<label for=\"deadline\">(yyyy-mm-dd):</label><input id=\"deadline\" value=\"$task->deadline\" name=\"deadline\" type=\"text\"><br>";
                            echo "<label>Description:</label><br>";
